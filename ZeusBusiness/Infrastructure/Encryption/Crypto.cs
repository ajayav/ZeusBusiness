...
namespace ZeusBusiness.Infrastructure.Encryption
{
    public class Crypto : ICrypto
    {
        public static string key = "rjSZEqHprMPrGvLuU1FHXwpkZYDVqbRa";
        ...
        {
            var randomBytes = new byte[16]; // 32 Bytes will give us 256 bits. We need only 16 for outlet
